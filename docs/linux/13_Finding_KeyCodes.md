...
2. On both console A and B change into the directory containing DOFLinx.pdb .  You may need to run a command like "find / - name DOFLinx.pdb" to find that location.
